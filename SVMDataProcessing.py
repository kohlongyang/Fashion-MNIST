...
#82.85 -> lower than without edge detection

#Dimension Reduction to p=100 using PCA
pca = PCA(n_components=100, random_state=42)
edge_detection_Xtrainpca = pca.fit_transform(edge_detection_Xtrain)
edge_detection_Xvalidpca = pca.transform(edge_detection_Xvalid)
edge_detection_Xtestpca = pca.transform(edge_detection_Xtest)

SVM.fit(edge_detection_Xtrainpca, edge_detection_Ytrain)
edge_detection_Y_predict = SVM.predict(edge_detection_Xtestpca)
accuracy = SVM.score(edge_detection_Xtestpca, edge_detection_Ytest)
print('SVM Model Accuracy After Edge Detection and PCA is:' ,accuracy)
#85.39

#With data augmentation -> accuracy decreases by about 5%
...
#81.17 -> decreased by quite alot lmao
